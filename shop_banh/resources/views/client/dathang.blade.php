				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="email" name="email" value="{{old('email')}}" required placeholder="expample@gmail.com">
						</div>
						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									@foreach($cart as $c)
										<div class="media">
											<img width="25%" src="{{asset('public/template/image/product/'.$c->options->image)}}" alt="" class="pull-left">
											<div class="media-body">
												<p class="font-large">{{$c->name}}</p>
												<span class="color-gray your-order-info">price: {{$c->price}}</span>
												<span class="color-gray your-order-info">quantity: {{$c->qty}}</span>
											</div>
										</div>
									@endforeach
									<!-- end one item -->
							...
							<div class="text-center"><input class="beta-btn primary" type="submit" value="Đặt hàng "><i class="fa fa-chevron-right"></i></input></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
